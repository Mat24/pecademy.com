...
ActiveRecord::Schema.define(version: 20141110004742) do
  ...
  add_index "tags_posts", ["posts_id"], name: "index_tags_posts_on_posts_id"
  add_index "tags_posts", ["tags_id"], name: "index_tags_posts_on_tags_id"

  create_table "users", force: true do |t|
    t.string   "email",                  default: "",    null: false
    t.string   "encrypted_password",     default: "",    null: false
    t.string   "nickname",               default: "",    null: false
    t.boolean  "es_administrador",       default: false, null: false
