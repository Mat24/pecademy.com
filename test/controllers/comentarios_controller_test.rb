...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { cuerpo: @comentario.cuerpo, fecha_creacion: @comentario.fecha_creacion, post_id: @comentario.post_id, user_id: @comentario.user_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { cuerpo: @comentario.cuerpo, fecha_creacion: @comentario.fecha_creacion, post_id: @comentario.post_id, user_id: @comentario.user_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
